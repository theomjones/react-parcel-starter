...
},{"fbjs/lib/invariant":15,"fbjs/lib/warning":17,"./lib/ReactPropTypesSecret":26}],12:[function(require,module,exports) {
...
},{"react":6}],5:[function(require,module,exports) {
"use strict";
...
var ClassyComp = function (_React$Component) {
  _inherits(ClassyComp, _React$Component);
  ...
  function ClassyComp() {
    ...
    _classCallCheck(this, ClassyComp);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ClassyComp.__proto__ || Object.getPrototypeOf(ClassyComp)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      title: "I am title from classy!"
    }, _this.getStatePlus = function () {
      return JSON.stringify(_extends({}, _this.state, { test: "cool" }));
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(ClassyComp, [{
    key: "render",
...
var _Classy = require("./components/Classy");

var _Classy2 = _interopRequireDefault(_Classy);
...
var App = function App(props) {
  return _react2.default.createElement(
    "div",
    null,
    _react2.default.createElement(_Header2.default, { title: "Header" }),
    _react2.default.createElement(
      "h1",
      null,
      props.title
    ),
    _react2.default.createElement(_Classy2.default, null)
  );
};

_reactDom2.default.render(_react2.default.createElement(App, { title: "Hello world." }), document.getElementById("app"));
},{"react":6,"react-dom":7,"./components/Header":4,"./components/Classy":5}],31:[function(require,module,exports) {
...
//# sourceMappingURL=/app.ff4b4f04.map